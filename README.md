...
We'll look at a ChatBot that will suggest a PMS (Patient Monetoring System). It can be integrated in a web application with Java. This is a FOSS projecta dn open for contributions. So expect more features to come soon.
...
Being a Spring Boot application. Ite very easy to deploye this project. Go to the github [repo](https://github.com/vijaykumar1710/CHATBOT-AIML-SPRINGBOOT).
